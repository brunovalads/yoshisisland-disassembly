...
CODE_1e5d:
  mov   a, #$80             ; $1e5d |
  mov   y, #$5c             ; $1e5f |
  call  CODE_05fa-$7FA8     ; $1e61 |
  mov   a, $03c3            ; $1e64 |
  and   a, #$80             ; $1e67 |
  beq   CODE_1e72           ; $1e69 |
  set7  $4a                 ; $1e6b |
  mov   y, #$4d             ; $1e6d |
  call  CODE_05fa-$7FA8     ; $1e6f |
CODE_1e72:
  mov   $05, #$00           ; $1e72 |
  clr7  $1a                 ; $1e75 |
  mov   x, #$0e             ; $1e77 | related to channel 7?
  mov   a, $021f            ; $1e79 |
  call  CODE_08b1-$7FA8     ; $1e7c |
  mov   a, #$00             ; $1e7f |
  mov   $03c9, a            ; $1e81 |
  mov   $d1, a              ; $1e84 |
  mov   $ae, a              ; $1e86 |
...
CODE_1f2c:
  ...
  call  CODE_1fb8-$8072     ; $1f2f |
  mov   a, #$80             ; $1f32 |
  call  CODE_3e79-$6564     ; $1f34 |
  clr7  $4a                 ; $1f37 | 
  mov   a, $4a              ; $1f39 |
  mov   y, #$4d             ; $1f3b |
  call  CODE_05fa-$7FA8     ; $1f3d |
  mov   a, #$01             ; $1f40 |
...
CODE_20C3:
  ...
  mov   $03f8, a                ; $20c9 |
  mov   y, #$5c                 ; $20cc |
  call  CODE_05fa-$7FA8         ; $20ce |
CODE_20D1:
  mov   a, $03                  ; $20d1 |
  bra   CODE_20E8               ; $20d3 |
CODE_20D5:
  jmp   CODE_2024-$8072         ; $20d5 |
CODE_20D8:
CODE_20d8:
  call  CODE_3ea6-$6564         ; $20d8 |
  mov   x, $03c0                ; $20db |
  mov   a, $03                  ; $20de |
  cmp   a, #$01                 ; $20e0 |
  beq   CODE_20B4               ; $20e2 |
...
CODE_20FA:
  cmp   a, #$21                 ; $20fa |
  bne   CODE_2101               ; $20fc |
  call  CODE_2086-$8072         ; $20fe |
CODE_2101:
  cmp   a, #$22                 ; $2101 |
  bne   CODE_2108               ; $2103 |
  call  CODE_209d-$8072         ; $2105 |
CODE_2108:
  mov   a, #$03                 ; $2108 |
  mov   $03a1+x, a              ; $210a |
  mov   a, #$00                 ; $210d |
...
CODE_216C:
  ...
  mov   $03a1+x, a              ; $2173 |
  beq   CODE_217B               ; $2176 |
  jmp   CODE_2164-$8072         ; $2178 | Why a jump instead of a branch?
CODE_217B:
  mov   a, $03a0+x              ; $217b |
  asl   a                       ; $217e |
  mov   y, a                    ; $217f |
...
CODE_2215:
  call  CODE_21a8-$8072         ; $2215 |
  jmp   CODE_2164-$8072         ; $2218 |
;

CODE_221B:
CODE_221b:
  call  CODE_3ea6-$6564         ; $221b |
  mov   $03c0, x                ; $221e |
  mov   a, $0391+x              ; $2221 |
  mov   y, a                    ; $2224 |
  mov   a, $0390+x              ; $2225 |
...
CODE_2238:
  ...
  mov   y, $03c2                ; $2267 |
  inc   y                       ; $226a |
  call  CODE_05fa-$7FA8         ; $226b |
  mov   a, x                    ; $226e |
  bra   CODE_227E               ; $226f |
CODE_2271:
  mov   y, $03c2                ; $2271 |
  inc   y                       ; $2274 |
  call  CODE_05fa-$7FA8         ; $2275 |
  mov   x, #$00                 ; $2278 |
  incw  $2c                     ; $227a |
  mov   a, ($2c+x)              ; $227c |
CODE_227E:
...
CODE_2285:
  ...
  mov   x, $03c0                ; $228d |
  mov   y, a                    ; $2290 |
  call  CODE_0505-$7FA8         ; $2291 |
  mov   a, $03c1                ; $2294 |
  call  CODE_3e79-$6564         ; $2297 |
...
CODE_22D0:
  ...
  mov   $44, x                  ; $22d9 |
  mov   y, a                    ; $22db |
  call  CODE_0505-$7FA8         ; $22dc |
  mov   a, $03c1                ; $22df |
  call  CODE_3e79-$6564         ; $22e2 |
CODE_22E5:
  mov   x, #$00                 ; $22e5 |
  incw  $2c                     ; $22e7 |
  mov   a, ($2c+x)              ; $22e9 |
  ...
  mov   x, $03c0                ; $2303 |
  mov   $44, x                  ; $2306 |
  call  CODE_0b1d-$7FA8         ; $2308 |
  jmp   CODE_229a-$8072         ; $230b |
