...
.init_egg_block 							 ; the ones that give you a single red/yellow/flashing egg
    JSL $03D406         ; $0580C4   |
    LDA $7360,x         ; $0580C8   |
    SEC                 ; $0580CB   |
    SBC #$0068          ; $0580CC   |
...
.main_egg_block 							 ; the ones that give you a single red/yellow egg
    STZ $7400,x         ; $0580E1   |
    LDY $7402,x         ; $0580E4   |
...
CODE_05827C:
    ...
    JMP CODE_050085     ; $0582B1   |
/

.init_large_spring_ball                      ; both sprite IDs
    LDA $7722,x         ; $0582B5   |
...
.main_large_spring_ball                      ; both sprite IDs
    JSL $03AA52         ; $058325   |
...
CODE_05894C:
    ...
    BEQ CODE_05894E     ; $05894D   |
    JSR CODE_05BB00     ; $05894F   |
    LDA $7A98,x         ; $058952   |
...
CODE_0593E0:
    ...
    LDX #$08            ; $059444   |
    LDA #$D883          ; $059446   |
    JSL $7EDE44         ; $059449   | GSU init
    BRA CODE_05946E     ; $05944D   |

CODE_05944F:
    LDX #$08            ; $05944F   |
    LDA #$D8F0          ; $059451   |
    JSL $7EDE44         ; $059454   | GSU init
    BRA CODE_05946E     ; $059458   |

CODE_05945A:
    LDX #$08            ; $05945A   |
    LDA #$D776          ; $05945C   |
    JSL $7EDE44         ; $05945F   | GSU init
    BRA CODE_05946E     ; $059463   |

CODE_059465:
    LDX #$08            ; $059465   |
    LDA #$D7FA          ; $059467   |
    JSL $7EDE44         ; $05946A   | GSU init
...
.init_checkered_block                        ; blue and red
    JSL $03AE60         ; $059D95   |
    LDA #$0100          ; $059D99   |
    STA $7A36,x         ; $059D9C   |
    STA $7A38,x         ; $059D9F   |
...
.main_checkered_block                        ; blue and red
    JSL $03AA52         ; $059DBC   |
    LDY $76,x           ; $059DC0   |
    CPY #$01            ; $059DC2   |
...
.init_wild_piranha                           ; regular and upside down
    INC $7402,x         ; $059F9F   |
    LDA $70E2,x         ; $059FA2   |
    STA $3010           ; $059FA5   |
    LDA $7182,x         ; $059FA8   |
...
.main_wild_piranha                           ; regular and upside down
    LDA $18,x           ; $059FE6   |
    AND #$00FF          ; $059FE8   |
    CMP #$0080          ; $059FEB   |
...
CODE_05C05B:
    ...
    PHD                 ; $05C065   |
    TSB $100D           ; $05C066   |
    BPL CODE_05C07B     ; $05C069   |
    BPL CODE_05C07D     ; $05C06B   |
    PHP                 ; $05C06D   |
...
.main_bucket_obj
    ...
    JMP CODE_0503A3     ; $05C4BE   |


CODE_05C4C2:
    JMP CODE_0503A3     ; $05C4C2   |
...
CODE_05D1CC:
    PLA                 ; $05D1CC   |
    JMP CODE_0503A3     ; $05D1CD   |

DATA_05D1D1:         dw $0022, $0024, $0020

.init_bullet_bill_blaster                    ; regular, biting, and bouncing
    LDA #$0100          ; $05D1D7   |
    STA $7A36,x         ; $05D1DA   |
    LDA $7360,x         ; $05D1DD   |
    SEC                 ; $05D1E0   |
...
.main_bullet_bill_blaster                    ; regular, biting, and bouncing
...
CODE_05E379:
    ...
    LDX #$09            ; $05E37D   |
    LDA #$9011          ; $05E37F   |
    JSL $7EDE44         ; $05E382   | GSU init
    BRA CODE_05E391     ; $05E386   |

CODE_05E388:
    LDX #$09            ; $05E388   |
    LDA $301E           ; $05E38A   |
    JSL $7EDE44         ; $05E38D   | GSU init
...
.init_arrow_wheel                            ; brown and blue
    JSL $03AE60         ; $05F07F   |
    LDA $7360,x         ; $05F083   |
    SEC                 ; $05F086   |
    SBC #$011E          ; $05F087   |
...
.main_arrow_wheel                            ; brown and blue
    STZ $7400,x         ; $05F09F   |
    JSL $03AA52         ; $05F0A2   |
    JSL $05F0FA         ; $05F0A6   |
...
.init_flopsy_fish                            ; swim & jumps in an arc and jumps 3 times
    SEP #$20            ; $05F6DE   |
    LDA #$FF            ; $05F6E0   |
    STA $7863,x         ; $05F6E2   |
    REP #$20            ; $05F6E5   |
...
.main_flopsy_fish                            ; swim & jumps in an arc and jumps 3 times
