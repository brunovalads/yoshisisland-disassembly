...
CODE_01919D:
    SEP #$20            ; $01919D   |
    LDA $9133,y         ; $01919F   | table
    STA $78,x           ; $0191A2   |
    LDA $9135,y         ; $0191A4   | table
    STA $105E           ; $0191A7   |
    REP #$20            ; $0191AA   |
    LDA #$0020          ; $0191AC   |
    STA $18,x           ; $0191AF   |
...
CODE_019D2D:
    ASL A               ; $019D2D   |
    TAY                 ; $019D2E   |
    LDA $9D03,y         ; $019D2F   | table
    STA $0C18           ; $019D32   |
    LDA #$6800          ; $019D35   |
    STA $0C1A           ; $019D38   |
    LDX $9D07,y         ; $019D3B   | table
    LDA $9D0B,y         ; $019D3E   | table
    JSL $00B756         ; $019D41   |
    STA $0C16           ; $019D45   |
    INC $0C14           ; $019D48   |
    PHA                 ; $019D4B   |
...
CODE_019E51:
    LDA $9DD6,x         ; $019E51   | table
    STA $7E5040,x       ; $019E54   |
    LDA $9DDD,x         ; $019E58   | table
    STA $7E51E4,x       ; $019E5B   |
    DEX                 ; $019E5F   |
...
CODE_01A169:
    STA $00             ; $01A169   |
    TAY                 ; $01A16B   |
    LDA $A059,y         ; $01A16C   | table
    STA $04             ; $01A16F   |
    LDA $A079,y         ; $01A171   | table
    STA $08             ; $01A174   |
    TYA                 ; $01A176   |
    BIT #$0010          ; $01A177   |
    BNE CODE_01A181     ; $01A17A   |
    LDA $A029,y         ; $01A17C   | table
    BRA CODE_01A18C     ; $01A17F   |

CODE_01A181:
    AND #$000E          ; $01A181   |
    TAY                 ; $01A184   |
    LDA $A029,y         ; $01A185   | table
    EOR #$FFFF          ; $01A188   |
    INC A               ; $01A18B   |

CODE_01A18C:
    STA $02             ; $01A18C   |
    LDA $A039,y         ; $01A18E   | table
    STA $06             ; $01A191   |
    LDA $A049,y         ; $01A193   | table
    STA $0A             ; $01A196   |
    LDA #$0223          ; $01A198   |
    JSL $008B21         ; $01A19B   |
    LDA $1084           ; $01A19F   |
...
CODE_01A2F5:
    REP #$10            ; $01A2F5   |
    LDY $18,x           ; $01A2F7   |
    LDA $A259,y         ; $01A2F9   | table
    STA $76,x           ; $01A2FC   |
    LDA $A25D,y         ; $01A2FE   | table
    STA $78,x           ; $01A301   |
    LDA $A25F,y         ; $01A303   | table
    STA $7A36,x         ; $01A306   |
    LDA $A261,y         ; $01A309   | table
    STA $7A38,x         ; $01A30C   |
    LDA $A25B,y         ; $01A30F   | table
    STA $7A96,x         ; $01A312   |
    LDY $76,x           ; $01A315   |
    LDA $A2CD,y         ; $01A317   | table
    AND #$00FF          ; $01A31A   |
    CLC                 ; $01A31D   |
    ADC $18,x           ; $01A31E   |
    STA $18,x           ; $01A320   |
...
; $A249 table sub
    ...
    LDY $7A38,x         ; $01A3EA   |
    LDA $A3B2,y         ; $01A3ED   | table
    STA $7A98,x         ; $01A3F0   |
    LDA $A3DA,y         ; $01A3F3   | table
    PHP                 ; $01A3F6   |
    LDA $7A36,x         ; $01A3F7   |
    STA $0093           ; $01A3FA   |
    CLC                 ; $01A3FD   |
    ADC $A3D0,y         ; $01A3FE   | table
    STA $7A36,x         ; $01A401   |
    LDA $78,x           ; $01A404   |
    STA $0091           ; $01A406   |
    CLC                 ; $01A409   |
    ADC $A3C6,y         ; $01A40A   | table
    STA $78,x           ; $01A40D   |
    LDA $A3BC,y         ; $01A40F   | table
    STA $0095           ; $01A412   |
    LDA #$0001          ; $01A415   |
    STA $008F           ; $01A418   |
    JSL $109295         ; $01A41B   |
...
CODE_01A850:
    LDA $A824,y         ; $01A850   | table
    AND #$00FF          ; $01A853   |
    STA $7402,x         ; $01A856   |
    LDA $A82A,y         ; $01A859   | table
    AND #$00FF          ; $01A85C   |
    STA $7A98,x         ; $01A85F   |
...
CODE_01A8A5:
    LDA $A862,y         ; $01A8A5   | table
    AND #$00FF          ; $01A8A8   |
    STA $7402,x         ; $01A8AB   |
    LDA $A875,y         ; $01A8AE   | table
    AND #$00FF          ; $01A8B1   |
    STA $7A98,x         ; $01A8B4   |
...
; flan table sub
    ...
    LDA $A8B7,y         ; $01A8CE   | table
    AND #$00FF          ; $01A8D1   |
    STA $7402,x         ; $01A8D4   |
    LDA $A8BB,y         ; $01A8D7   | table
    AND #$00FF          ; $01A8DA   |
    STA $7A98,x         ; $01A8DD   |
...
CODE_01A9E0:
    LDA $A8E0,y         ; $01A9E0   | table
    AND #$00FF          ; $01A9E3   |
    STA $7402,x         ; $01A9E6   |
    LDA $A8E7,y         ; $01A9E9   | table
    AND #$00FF          ; $01A9EC   |
    STA $7A98,x         ; $01A9EF   |
...
CODE_01ACE6:
    ...
    TAY                 ; $01ACFB   |
    LDA $AC7A,y         ; $01ACFC   | table
    STA $75E0,x         ; $01ACFF   |
    LDA $00             ; $01AD02   |
    LSR A               ; $01AD04   |
    STA $78,x           ; $01AD05   |
    TAY                 ; $01AD07   |
    LDA $AC82,y         ; $01AD08   | table
    STA $7540,x         ; $01AD0B   |
    RTL                 ; $01AD0E   |
