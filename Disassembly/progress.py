...
def calculate_progress(verbose):
    ...
    done_banks = ['bank00.txt', 'bank01.txt', 'bank03.txt', 'bank08.txt', 'bank09.txt', 'bank0B.txt', 'bank0D.txt', 'bank0E.txt', 'bank10.txt', 'bank11.txt', 'bank14.txt', 'bank15.txt', 'bank16.txt', 
