...
def calculate_progress(verbose):
    ...
    done_banks = ['bank00.txt', 'bank01.txt', 'bank02.txt', 'bank03.txt', 'bank06.txt', 'bank08.txt', 'bank09.txt',
    'bank0A.txt', 'bank0B.txt', 'bank0D.txt', 'bank0E.txt', 'bank0F.txt', 'bank10.txt', 'bank11.txt', 'bank14.txt',
    'bank15.txt', 'bank16.txt', 'bank17.txt', 'bank18.txt', 'bank19.txt', 'bank1A.txt', 'bank1B.txt', 'bank1C.txt',
    'bank1D.txt', 'bank1E.txt', 'bank1F.txt', 'bank20.txt', 'bank21.txt', 'bank22.txt', 'bank23.txt', 'bank24.txt',
    ...
    'bank3D.txt', 'bank3E.txt', 'bank3F.txt']
