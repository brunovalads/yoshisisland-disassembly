...
def calculate_progress(verbose):
    ...
    done_banks = ['bank00.txt', 'bank01.txt', 'bank03.txt', 'bank0E.txt', 'bank19.txt', 'bank1A.txt', 'bank1B.txt', 'bank1C.txt', 'bank1D.txt', 'bank1E.txt', 'bank1F.txt', 'bank23.txt', 'bank24.txt',
