...
CODE_08851B:         with r1            ;
CODE_08851C:         or    #4           ; bit 0 is flag for high nibble of color data
CODE_08851E:         from r1            ;
CODE_08851F:         cmode              ;
...
CODE_08A419:         link  #4           ; which goes through table
...
CODE_08A42A:         mult  #5           ; multiplies by 20 and computes full address
...
CODE_08A695:         sub   #0           ; happens
CODE_08A697:         beq CODE_08A6A7+1  ;
...
CODE_08A705:         link  #4           ;  | in a similar fashion as above
...
CODE_08A886:         to r1              ;
CODE_08A887:         sub   #8           ; r1 = x - 8
CODE_08A889:         lms   r0,($0024)   ;
CODE_08A88C:         to r2              ;
CODE_08A88D:         sub   #8           ; r2 = y - 8
...
CODE_08A8DD:         and   #2           ; for high table
...
CODE_08B26D:         dec   r5           ; \
CODE_08B26E:         with r3            ;
CODE_08B26F:         sub   #6           ; / move indices one full entry backwards

CODE_08B271:         from r3            ;
CODE_08B272:         sub   r2           ; \ if forward & reverse indices
CODE_08B273:         bcc CODE_08B289    ; / run into each other, break
CODE_08B275:         with r1            ;
CODE_08B276:         add   #8           ; \ increment OAM buffer index
...
CODE_08BA75:         add   r6           ;
CODE_08BA76:         dec   r7           ;
CODE_08BA77:         bne CODE_08BA6E+1  ;
CODE_08BA79:         with r5            ;
CODE_08BA7A:         move  r14,r1       ;
CODE_08BA7C:         getb               ;
CODE_08BA7D:         inc   r14          ;
CODE_08BA7E:         getbh              ;
CODE_08BA80:         inc   r14          ;
...
CODE_08D637:         nop                ;
CODE_08D638:         to r6              ;
CODE_08D639:         moves r10,r10      ;
CODE_08D63B:         bne CODE_08D641+1  ;
...
CODE_08DC88:         and   #15          ;  | skip it and back out, which
