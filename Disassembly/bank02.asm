...
CODE_02A070:
    ...
    DEC $0057           ; $02A082   |
    LDA #$001E          ; $02A085   |
    JMP CODE_020085     ; $02A088   |

CODE_02A08C:
    LDA $7182,x         ; $02A08C   |
    CMP #$0800          ; $02A08F   |
    BMI CODE_02A098     ; $02A092   |
    JMP CODE_0203A3     ; $02A094   |
...
CODE_02C89D:
    JMP CODE_0203A3     ; $02C89D   |

CODE_02C8A1:
    JSL $03AD74         ; $02C8A1   |
    BCS CODE_02C8AA     ; $02C8A5   |
    JMP CODE_02A31E     ; $02C8A7   |
